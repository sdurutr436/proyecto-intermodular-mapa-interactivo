...
const detectLanguage = (text) => {
    try {
        ...
        const languageKeywords = {
            'es': ['hola', 'adiós', 'adios', 'gracias', 'por favor', 'buenos días', 'buenas tardes', 'buenas noches', 
                   'qué tal', 'que tal', 'cómo', 'como', 'dónde', 'donde', 'cuándo', 'cuando', 'sí', 'si', 
                   'año', 'español', 'mañana', 'también', 'tambien', 'después', 'despues'],
            'en': ['hello', 'hi', 'goodbye', 'bye', 'thanks', 'thank you', 'please', 'good morning', 'good afternoon',
                   'how are you', 'what', 'where', 'when', 'yes', 'yeah', 'the', 'and', 'with', 'from'],
            'fr': ['bonjour', 'salut', 'au revoir', 'merci', "s'il vous plaît", "s'il te plaît", 'bonsoir',
                   'comment allez-vous', 'très', 'avec', 'français', 'après', 'être', 'avoir'],
            'de': ['guten tag', 'guten morgen', 'guten abend', 'auf wiedersehen', 'tschüss', 'tschuss', 'danke', 
                   'bitte', 'wie geht', 'deutsch', 'über', 'sehr', 'auch'],
            'it': ['ciao', 'buongiorno', 'buonasera', 'arrivederci', 'grazie', 'per favore', 'come stai',
                   'molto', 'anche', 'italiano', 'dopo', 'prima'],
            'pt': ['olá', 'ola', 'oi', 'tchau', 'obrigado', 'obrigada', 'por favor', 'bom dia', 'boa tarde',
                   'como vai', 'tudo bem', 'você', 'voce', 'também', 'depois', 'português'],
        };
...
router.post('/', async (req, res) => {
    try {
        ...
        // MyMemory usa códigos ISO 639-1 estándar
        ...
        // Detectar el idioma de origen automáticamente
        ...
        // Buscar el error más específico que coincida
